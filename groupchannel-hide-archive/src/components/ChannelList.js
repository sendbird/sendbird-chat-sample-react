...
function ChannelList({
                       ...
                       setChannelHeaderName, setChannelList, setMessageList, setMembers, setShowChannelInformation,
                       setShowChannelFilterModal, loadMoreChannelList,
                     }) {
  ...
  const handleShowChannelFilterModal = () => {
    setShowChannelFilterModal(true);
  };
  ...
  const handleCreateChannel = useCallback(async (channelName, invitedUserIds, customType) => {
  ...
  return (
    <div className="left-bar">
      <div ref={headerRef} className="header">
        ...
        <div className="channelIcons" style={{marginRight: 10}} >
          <Filter style={{marginRight: 10}} onClick={handleShowChannelFilterModal}/>
