...
import GroupChannelSampleTypingIndicator from './samples/GroupChannelSampleTypingIndicator';
  ...
  return (
    <div className="container">
      <Routes>
        ...
        <Route path='/group-channel-typing-indicator' element={<GroupChannelSampleTypingIndicator />} />
