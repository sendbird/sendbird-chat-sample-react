...
const GroupChannelArchive = (props) => {
    ...
    const handleArchiveChannel = async (channelUrl) => {
        try {
            ...
            const updatedArchiveChannels = state.archiveChannels.filter(
                (channel) => {
                    return channel.url !== channelUrl
                }
            )
    ...
    const handleChangeSortChannels = async (event) => {
        if (event.target.value === 'all') {
            ...
            updateState({
                ...state,
                channels: channels,
                sortChannels: event.target.value,
            })
...
const ChannelList = ({
    ...
    return (
        <div className="channel-list">
            ...
            {(sortChannels === 'all' ? channels : archiveChannels).map(
                (channel) => {
                    return (
                        <div key={channel.url} className="channel-list-item">
                            ...
                            <div>
                                <button
                                    ...
                                    onClick={() =>
                                        handleArchiveChannel(channel.url)
                                    }
                                >
                                    <img
