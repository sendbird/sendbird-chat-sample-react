...
const GroupChannelReportAMessageUserChannel = (props) => {
    ...
    const sendReport = async () => {
        ...
        switch (reportKey) {
            case 'Message':
                // Report a message.
                await currentlyJoinedChannel.reportMessage(
                    reportObject,
                    reportCategoriesInputValue,
                    reportDescriptionInputValue
                )
...
const ChannelList = ({
    ...
    return (
        <div className="channel-list">
            ...
            {showNotification && !currentlyJoinedChannel && (
                <div
                    className="report-notification"
                    onClick={() => toggleNotificationMessage('')}
                >{`${reportNotification} was reported`}</div>
            )}
                ...
                return (
                    <div key={channel.url} className="channel-list-item">
                        ...
                        <button
                            className="control-button"
                            onClick={() =>
                                toggleReportModal(channel, 'Channel')
                            }
                        >
                            <img
                                className="oc-channel-list-icon"
                                style={{ width: '19px' }}
                                src="/report_icon.png"
                            />
                        </button>
    ...
    if (message.url) {
        return (
            ...
            >
                ...
                <button
                    className="control-button"
                    onClick={() => toggleReportModal(message, 'Message')}
                >
                    <img
                        className="message-icon"
                        style={{ width: '19px' }}
        ...
        return (
            <div className="overlay">
                <div className="overlay-content">
                    ...
                    <label htmlFor="report_categories">
                        Report categories:{' '}
                    </label>
                    <select
