    ...
    const handleBannedOrMutedMembers = async (e) => {
        ...
        switch (e.currentTarget.value) {
            case 'empty':
                ...
                break
            case 'banned_users':
                const bannedUsers = await getBannedOrMutedUsers(
                    currentlyJoinedChannel,
                ...
                break
            case 'muted_users':
                const mutedUsers = await getBannedOrMutedUsers(
                    currentlyJoinedChannel,
        ...
        return (
            <div className="members-list">
                ...
                {channel.myRole === 'operator' && (
                    <div className="banned-muted-users-list">
                        <select
                            onChange={(event) =>
                                handleBannedOrMutedMembers(event)
                            }
                        >
