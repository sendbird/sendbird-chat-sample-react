...
const GroupChannelPinnedMessages = (props) => {
    ...
    const handleDeleteMessage = async (messageToDelete) => {
        ...
        updateState({
            ...state,
            pinnedMessageIds: state.pinnedMessageIds.filter(
                (pinnedMessageId) =>
                    pinnedMessageId !== messageToDelete.messageId
            ),
        })
    }
    ...
    const handleUnpinMessage = async (message) => {
        ...
        updateState({
            ...state,
            pinnedMessageIds: state.pinnedMessageIds.filter(
                (pinnedMessageId) => pinnedMessageId !== message.messageId
            ),
        })
    }
        ...
        <>
            ...
            <ErrorModal
                isMaxCountPinnedMessagesError={
                    state.isMaxCountPinnedMessagesError
                }
        ...
        return (
            <div className="channel" ref={channelRef}>
                ...
                <div>
                    ...
                    >
                        {pinnedMessageIds.length} pinned
                    </button>
                </div>
                <div>{children}</div>
            </div>
        ...
        <div className="message-input">
            ...
            <div className="message-input-buttons">
                ...
                <div className="freeze-channel pin-checkbox">
                    <input
                        type="checkbox"
                        onChange={toggleIsPinMessage}
                        checked={isPinMessage}
                    />
                    pin
                </div>
        ...
        return (
            <div className="overlay ">
                <div className="overlay-content scheduled-messages-list-modal">
                    <div>
                        <p>
                            The maximum number of pinned messages cannot exceed
                            10
                        </p>
                    </div>
