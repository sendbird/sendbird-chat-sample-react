...
const OpenChannelSendAndReceiveVariousTypesOfFiles = (props) => {
        ...
        return (
            <div className="oc-message">
                ...
                {isImageMessage ? (
                    ...
                    <a
                        className="oc-document-message"
                        href={message.url}
                        download={message.name}
                    >
                        <img
                            className="oc-document-message-icon"
...
export default OpenChannelSendAndReceiveVariousTypesOfFiles
