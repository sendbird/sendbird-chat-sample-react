...
const GroupChannelStructuredData = (props) => {
...
const Message = ({
    ...
    return (
        <div
            className={`message message--group ${
                messageSentByYou ? 'message-from-you' : ''
            }`}
        >
        ...
        <div className="message-input">
            ...
            <div className="message-input-buttons">
                ...
                <label
                    ...
                    onClick={toggleShowAddDataToMessage}
                >
                    Add data
                </label>
                <input
            ...
            <div className="overlay">
                <div className="overlay-content">
                    ...
                    <div>
                        ...
                        <input
                            className="form-input"
                            ref={messageDataImageRef}
                        />
                    </div>
                    <div>
                        <button
                            className="form-button"
                            onClick={handleAddDataToMessage}
                        >
                            Save
                        </button>
                        <button
...
export default GroupChannelStructuredData
