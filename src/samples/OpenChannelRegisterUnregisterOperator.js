    ...
    if (currentlyJoinedChannel) {
        ...
        return <div className="channel">
            ...
            <div>
                ...
                {isOperator && <button className="leave-channel register-as-operator-btn" onClick={toggleMembersList}>Register as operator</button>}
            </div>
            <div>{children}</div>
        </div>;
...
const MembersList = ({ toggleMembersList, isShowMembersList, users, registerUnregisterAnOperator, userIsOperator, userIdInputValue, operators }) => {
          ...
          {users.map((user) => {
              ...
              return(
                <div key={user.userId}>
                  ...
                  {/* {!isOperator && <div className="member-item">{user.nickname}</div>} */}
                </div>
              )
            })}
      </div>;
