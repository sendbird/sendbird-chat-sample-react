...
const GroupChannelRetrieveNumberOfMembersHaventReceivedMessage = (props) => {
    ...
    const getNumberOfUndeliveredMembers = (message) => {
        const { currentlyJoinedChannel } = state
        const numberOfUndeliveredMembers =
            currentlyJoinedChannel.getUndeliveredMemberCount(message)

        updateState({
            ...state,
            numberOfUndeliveredMembers,
        ...
        <>
            ...
            >
                <MessagesList
                    ...
                    numberOfUndeliveredMembers={
                        state.numberOfUndeliveredMembers
                    }
                    getNumberOfUndeliveredMembers={
                        getNumberOfUndeliveredMembers
                    }
                    closeNumberOfUndeliveredMembers={
                        closeNumberOfUndeliveredMembers
                    }
...
const Message = ({
    ...
    const messageSentByCurrentUser =
        message.sender.userId === sb.currentUser.userId
    const showNumberOfUndeliveredMembers =
        numberOfUndeliveredMembers &&
    ...
    if (message.url) {
        return (
            ...
            >
                    ...
                    {messageSentByCurrentUser && (
                        <div>
                            <button
                                ...
                                data-title="Get number of undelivered members"
                                onClick={() =>
                                    getNumberOfUndeliveredMembers(message)
                                }
                            >
                                <img
                                    className="message-icon"
                                    src="/icon_not_delivered.png"
                                />
                            </button>
                        </div>
                    )}
                ...
                <img src={message.url} />
                {showNumberOfUndeliveredMembers && (
                    <div className="number-of-undelivered-members">
                        Number of members unreceived a message:{' '}
                        {numberOfUndeliveredMembers}
                        <span
                            className="number-of-undelivered-members-btn"
                            onClick={closeNumberOfUndeliveredMembers}
                        >
                            &#10006;
                        </span>
                    </div>
