...
const GroupChannelOgTags = (props) => {
...
const Message = ({
    ...
    return (
        ...
        >
            ...
            {message.ogMetaData && (
                <div className="message-og-tags">
                    <a className="og-tags-url" href={message.ogMetaData.url}>
                        {message.ogMetaData.url}
                    </a>
                    <h3 className="og-tags-title">
                        {message.ogMetaData.title}
                    </h3>
                    <p className="og-tags-description">
                        {message.ogMetaData.description}
                    </p>
                    <img
                        className="og-tags-img"
                        src={message.ogMetaData.defaultImage.url}
                    />
                </div>
            )}
        </div>
...
export default GroupChannelOgTags
