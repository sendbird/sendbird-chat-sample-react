...
const BasicGroupChannelSample = (props) => {
    ...
    const postPoll = async () => {
        ...
        if (pollMessageToUpdate) {
            await currentlyJoinedChannel.updatePoll(
                pollMessageToUpdate._poll.id,
                params
            )
    ...
    const addPollOption = () => {
        if (state.pollOptionValue) {
            updateState({
                ...state,
                pollOptionsArray: [
                    ...state.pollOptionsArray,
                    state.pollOptionValue,
                ],
                pollOptionValue: '',
            })
        }
    ...
    const removeOption = (e) => {
        const newPollOptionsArray = state.pollOptionsArray.filter(
            (value) => value !== e.currentTarget.innerHTML
        )
    ...
    const addOrRemoveVoice = async (e, option, message, poll) => {
        const { userIdInputValue, checkedOptions, currentlyJoinedChannel } =
            state
        ...
        let pollEvent = new PollVoteEvent(
            pollId,
            messageId,
            pollVoteEventPayload
        )
    ...
    const updateOption = async () => {
        ...
        await currentlyJoinedChannel.updatePollOption(
            optionToUpdate.pollId,
            optionToUpdate.id,
            updatedPollOptionText
        )
    ...
    const addNewOption = async () => {
        ...
        await currentlyJoinedChannel.addPollOption(
            currentPoll.id,
            newPollOptionText
        )
        ...
        <div className="message-input">
            ...
            <div className="message-input-buttons">
                ...
                <button
                    ...
                    onClick={() => isShowCreatePollModal('open')}
                >
                    Create poll
                </button>
        ...
        return (
            <div className="overlay">
                <div className="overlay-content create-poll-modal">
                    ...
                    <div className="create-poll-modal_inputs">
                        ...
                        <div className="input_wrapper">
                            <input
                                ...
                                onChange={(e) =>
                                    onPollInputsChange(e, 'pollTitleValue')
                                }
                            />
                        </div>
                        ...
                        <div className="input_wrapper">
                            <input
                                ...
                                onChange={(e) =>
                                    onPollInputsChange(e, 'pollOptionValue')
                                }
                            />
                            <button
                                className="option-add_btn"
                    ...
                    <button className="poll-create_btn" onClick={postPoll}>
                        Create and send
                    </button>
                    <span
                        className="poll-close_btn"
                        onClick={() => isShowCreatePollModal('close')}
                    >
                        &#10006;
                    </span>
                </div>
                ...
                <div className="overlay-content create-poll-modal">
                    <div className="option input_wrapper">
                        <input
                            ...
                            onChange={(e) =>
                                onPollInputsChange(e, 'updatedPollOptionText')
                            }
                        />
                        <button
                            className="option-add_btn"
                ...
                <div className="overlay-content create-poll-modal">
                    <div className="option input_wrapper">
                        <input
                            ...
                            onChange={(e) =>
                                onPollInputsChange(e, 'newPollOptionText')
                            }
                        />
                        <button
                            className="option-add_btn"
