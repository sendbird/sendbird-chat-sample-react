...
const GroupChannelUpdateDeleteMessageByOperator = (props) => {
    ...
    const handleJoinChannel = async (channelUrl) => {
        ...
        updateState({ ...state, messageCollection: collection, loading: false, members: channel.members, userIsOperator: userIsOperator })
    }
...
const Message = ({ message, updateMessage, handleDeleteMessage, messageSentByYou, currentlyJoinedChannel }) => {
    if (message.url) {
        return (
