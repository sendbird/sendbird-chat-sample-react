...
const GroupChannelUpdateDeleteMessageByOperator = (props) => {
    ...
    const handleJoinChannel = async (channelUrl) => {
        ...
        const memberIndex = channel.members.findIndex(
            (item) => item.userId === userIdInputValue
        )
...
const Message = ({
    ...
    const showAdditionalMessageControls =
        message.sender.userId === sb.currentUser.userId ||
        currentlyJoinedChannel.myRole === 'operator'
...
export default GroupChannelUpdateDeleteMessageByOperator
