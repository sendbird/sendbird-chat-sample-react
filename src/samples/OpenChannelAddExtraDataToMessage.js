    ...
    const sendMessage = async () => {
        ...
        if (messageToUpdate) {
            ...
            if (isMessageExtraData) {
                const meta = new MessageMetaArray({
                    key: 'required',
                    value: ['true'],
                })
...
const Channel = ({
    ...
    handleLeaveChannel,
    children,
    toggleShowRequiredMessages,
    isShowRequiredMessages,
    channelRef,
}) => {
        ...
        return (
            <div className="channel" ref={channelRef}>
                ...
                <div>
                    ...
                    <button
                        className="leave-channel"
                        onClick={toggleShowRequiredMessages}
                    >
                        {isShowRequiredMessages
                            ? 'Show all messages'
