...
const GroupChannelUserProfileUpdate = (props) => {
    ...
    const setupUser = async () => {
        ...
        updateState({
            ...
            loading: false,
            settingUpUser: false,
            currentUser: sb.groupChannel._sessionManager.currentUser,
        })
    }
    ...
    return (
        <>
            ...
            <UserProfileModal
                ...
                userProfileNicknameInputValue={
                    state.userProfileNicknameInputValue
                }
                toggleUserProfileModal={toggleUserProfileModal}
...
const UserProfileModal = ({
    isUserProfileModal,
    toggleUserProfileModal,
    onProfileImageInputChange,
    onProfileNicknameInputChange,
            ...
            <div className="overlay">
                <div className="overlay-content">
                    ...
                    <div className="user-profile-image-wrapper">
                        ...
                        />
                        <label
                            className="user-profile-image-upload-label"
                            htmlFor="profile_img"
                        >
                            Upload
                        </label>
                    ...
                    <div className="user-profile-nickname-wrapper">
                        ...
                        />
                        <button
                            className="user-profile-nickname-button"
                            onClick={updateUserProfileNickname}
                        >
                            Update
                        </button>
                    </div>
