...
// Chat UI Components
const ChannelList = ({ channels, currentCustomType, handleChangeCustomType, handleJoinChannel, toggleShowCreateChannel, handleDeleteChannel, toggleChannelDetails }) => {
    return (
