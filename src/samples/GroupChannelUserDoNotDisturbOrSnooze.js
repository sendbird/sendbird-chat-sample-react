    ...
    const toggleNotificationsSettingModal = () => {
        updateState({
            ...
            isShowNotificationsSettingModal:
                !state.isShowNotificationsSettingModal,
        })
    }
    ...
    return (
        <>
            ...
            <NotificationsSettingModal
                ...
                doNotDisturbStartHoursInputValue={
                    state.doNotDisturbStartHoursInputValue
                }
                doNotDisturbStartMinutesInputValue={
                    state.doNotDisturbStartMinutesInputValue
                }
                doNotDisturbEndHoursInputValue={
                    state.doNotDisturbEndHoursInputValue
                }
                doNotDisturbEndMinutesInputValue={
                    state.doNotDisturbEndMinutesInputValue
                }
        ...
        <div className="channel-list">
            <div className="channel-type">
                ...
                <button
                    className="channel-create-button"
                    style={{ marginTop: '5px' }}
                    onClick={() => toggleNotificationsSettingModal()}
                >
                ...
                <div className="overlay-content notifications-overlay-content">
                    <div className="do-not-disturb-wrapper">
                        ...
                        <div className="do-not-disturb-start-wrapper">
                            <label
                                className="notification-modal-label"
                                htmlFor="start-hours"
                            >
                                Hours
                            </label>
                    ...
                    <div className="notifications-snooze-wrapper">
                        ...
                        <button
                            className="channel-create-button"
                            onClick={addNotificationsSnooze}
                        >
                            Add
                        </button>
                    </div>
                    <button onClick={toggleNotificationsSettingModal}>
                        Cancel
                    </button>
                </div>
            </div>
