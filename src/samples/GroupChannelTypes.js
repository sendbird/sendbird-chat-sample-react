...
const GroupChannelTypes = (props) => {
    ...
    const handleJoinChannel = async (channelUrl) => {
        ...
        channelHandler.onUserReceivedInvitation = () => {
            alert('Accepted an invitation')
        }
        channelHandler.onUserDeclinedInvitation = () => {
            alert('Declined an invitation.')
        }
                    ...
                    return (
                        <div key={channel.url} className="channel-list-item">
                            ...
                            >
                                ...
                                {channel.isPublic && (
                                    <sup className="channel-list-item-sup">
                                        public
                                    </sup>
                                )}
                ...
                <div className="overlay-content">
                    <div className="create-channel-wrapper">
                        ...
                        {!currentlyJoinedChannel && (
                            <>
                                <input
                                    className="create-channel-checkbox"
                                    onChange={(e) =>
                                        onCreateChannelCheckboxChange(e)
                                    }
                                    type="checkbox"
                                    id="supergroup"
                                    name="supergroup"
                                ...
                                <input
                                    className="create-channel-checkbox"
                                    onChange={(e) =>
                                        onCreatePublicChannelCheckboxChange(e)
                                    }
                                    type="checkbox"
                                    id="public-channel"
                                    name="public-channel"
...
const createChannel = async (
    ...
    try {
        ...
        groupChannelParams.name = isCreateSuperGroup
            ? 'Supergroup channel'
            : channelName
