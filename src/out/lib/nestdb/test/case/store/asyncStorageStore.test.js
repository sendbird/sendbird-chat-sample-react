...
const asyncStorageStore_1 = require("../../../src/store/asyncStorageStore");
const DBNAME = 'testdb';
const createStore = (arg = {}) => new asyncStorageStore_1.default(Object.assign({ AsyncStorage: async_storage_1.default }, arg));
describe('[unit] asyncStorageStore', () => {
...
//# sourceMappingURL=asyncStorageStore.test.js.map