...
class ConnectionReconnectingState extends baseState_1.default {
    constructor() {
        super(...arguments);
        this.type = stateType_1.ConnectionStateType.RECONNECTING;
    ...
    run(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let error = null;
            context.connectionHandlers.forEach(handler => handler.onReconnectStarted());
            try {
                const { reconnectMaxRetry, reconnectRetryStrategy } = context.sdkState.websocket;
                ...
                }), reconnectMaxRetry, reconnectRetryStrategy);
                yield context.changeState(new connectedState_1.default());
            }
            catch (err) {
                error = err;
                yield context.changeState(new disconnectedState_1.default({ autoReconnect: false }));
            }
            finally {
                context.connectionHandlers.forEach(handler => {
                    !error ? handler.onReconnectSucceeded() : handler.onReconnectFailed();
                });
    ...
    onDisconnect(context, { error = null, autoReconnect = true }) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = ConnectionReconnectingState;
//# sourceMappingURL=reconnectingState.js.map